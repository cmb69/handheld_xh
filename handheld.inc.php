...
/**
 * Mobile browser detection of Handheld_XH.
 *
...
/**
 * Returns whether the user agent is a mobile browser.
 *
...
function Handheld_detected()
{
    ...
    $res = preg_match(
        ...
        . '|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo'
    ...
    $res = $res || preg_match(
        ...
        . '|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs'
        . '|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)'
        ...
        . '|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio'
        . '|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9'
