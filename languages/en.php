...
$plugin_tx['handheld']['cf_mode']="The mode for mobile browsers: \"0\" (do nothing), \"1\" (redirect to another domain), \"2\" (redirect to a CMSimple subsite) or \"3\" (use another template)";
...
$plugin_tx['handheld']['error_redirect_details']="Headers were already sent from {file} on line {line}.";
